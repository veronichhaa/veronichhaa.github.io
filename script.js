...
let tests = [
    ...
    {   name: 'Пункция пальпируемого образования в правом подреберье под контролем УЗИ',
        ...
        point: -1,
        note: 'Пункция желчного пузыря не показана'
    },
...
let treatments = [
    ...
    },
    {
        ...
        note: function () {
            ...
            else return "Ок, но показано проведение послеоперационной полихимиотерапии";
        }
    },
    {
    ...
    },
    {
        ...
        note: function () {
            if(isPunction()) return "Необходимо экстренное вмешательство по поводу перфорации желчного пузыря;</br>";
            else return "При визуализации подозрительного на злокачественный резектабельного очага в поджелудочной железе предоперационное морфологическое подтверждение диагноза не требуется - международный консенсус. <br>2 - при неосложненной механической желтухе с уровнем общего билирубина до 250 мкмоль/л предоперационное билиарное дренирование не показано";
        }
    },
    {
